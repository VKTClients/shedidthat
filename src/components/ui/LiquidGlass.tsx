...
export function LiquidGlass({
  ...
  const getVariantClasses = () => {
    ...
    switch (variant) {
      ...
      case "panel":
        return `${baseClasses} p-8 rounded-3xl`
      case "floating":
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent pointer-events-none" style={{ zIndex: 5 }} />
    </div>
  )
}
